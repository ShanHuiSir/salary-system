...
export const defaultFieldConfigs: FieldConfigs = {
  ...
  costStructure: [
    ...
    { key: 'annualLeaveAllowance', label: '年假补贴(万)', type: 'number', required: true, suffix: '万', visibleInList: true, system: false, order: 6 },
    { key: 'sickLeavePay', label: '病假工资(万)', type: 'number', required: true, suffix: '万', visibleInList: true, system: false, order: 7 },
    { key: 'maternityLeavePay', label: '产假工资(万)', type: 'number', required: true, suffix: '万', visibleInList: true, system: false, order: 8 },
    { key: 'otherPayable', label: '其他应发(万)', type: 'number', required: true, suffix: '万', visibleInList: true, system: false, order: 9 },
    { key: 'employerSocialInsurance', label: '单位社保公积金(万)', type: 'number', required: true, suffix: '万', visibleInList: true, system: false, order: 10 },
  ],
};
